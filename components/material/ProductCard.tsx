...
const ProductCard = ({ item, indx }: { item: IProduct, indx: number }) => {
    return (
        <div
            data-aos="fade-up"
            data-aos-duration={`${indx + 1}50`}
            className='rounded-xl dark:bg-primary/10 bg-gray-50 overflow-hidden p-10 relative' >
            ...
            <div className='flex flex-col items-center gap-y-3'>
                ...
                <div className='flex items-center gap-x-3 mt-5'>
                    ...
                    <Link href={`/product-detail/${item.id}`} className='button-inx w-30 flex justify-center items-center'>
